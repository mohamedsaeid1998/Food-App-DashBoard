...
const CategoriesList = () => {
  ...
  return <>
    <ModalUi key={Math.random()} title="Categories" {...{ setModalState, modalState, itemId, itemName }} />
    ...
    <TableData key={Math.random()} location="category" {...{ showDeleteModal, showEditModal }} />
  </>
}
